...
function Searchbar({ onSearch, Search, Placeholder }) {
    ...
    return (
        <>
            <div className="flex border border-gray-300  rounded-2xl w-[80%] focus-within:border-violet-500 bg-white focus-within:shadow-md transition">
                ...
                <input placeholder={Placeholder} className="h-12 w-full outline-none" value={Search} onChange={(e) => onSearch(e.target.value)} />
            </div>
        </>
    )
}
