...
function Hero() {
    return (
        <div className="flex flex-col items-center w-screen h-screen">
            <div className="h-fit w-[90%] m-20   border border-gray-100 flex flex-col grow gap-7 p-10 bg-white rounded-2xl">
            ...
            <div className="h-fit m-20 mr-10 rounded-2xl  flex flex-col gap-2 p-4 ">
                ...
                <div className="grid grid-cols-4 gap-4  place-items-start max-w-[95%]">
